...
from app.models import FasttextVector
...
class InputWords(FlaskForm):
    ...
    def validate_word1(self, word1):
        ...
        word1_grapheme = FasttextVector.query.filter(FasttextVector.grapheme.in_(word1_alternates)).first()
    ...
    def validate_word2(self, word2):
        ...
        word2_grapheme = FasttextVector.query.filter(FasttextVector.grapheme.in_(word2_alternates)).first()
